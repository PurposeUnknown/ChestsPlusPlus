...
public class ChestsPlusPlusTag {
    ...
    static {
        ...
        WOOD_MATERIAL = new Tag() {
            ...
            @Override
            public boolean isTagged(@NotNull Keyed item) {
                return item.equals(Material.ACACIA_BOAT) || item.equals(Material.ACACIA_CHEST_BOAT) || item.equals(Material.ACACIA_DOOR) || item.equals(Material.ACACIA_FENCE) || item.equals(Material.ACACIA_FENCE_GATE) || item.equals(Material.ACACIA_HANGING_SIGN) || item.equals(Material.ACACIA_PLANKS) || item.equals(Material.ACACIA_SIGN) || item.equals(Material.ACACIA_SLAB) || item.equals(Material.ACACIA_STAIRS) || item.equals(Material.ACACIA_TRAPDOOR) || item.equals(Material.ACACIA_WALL_HANGING_SIGN) || item.equals(Material.ACACIA_WALL_SIGN) || item.equals(Material.BAMBOO_BLOCK) || item.equals(Material.BAMBOO_CHEST_RAFT) || item.equals(Material.BAMBOO_DOOR) || item.equals(Material.BAMBOO_FENCE) || item.equals(Material.BAMBOO_FENCE_GATE) || item.equals(Material.BAMBOO_HANGING_SIGN) || item.equals(Material.BAMBOO_MOSAIC) || item.equals(Material.BAMBOO_MOSAIC_SLAB) || item.equals(Material.BAMBOO_MOSAIC_STAIRS) || item.equals(Material.BAMBOO_PLANKS) || item.equals(Material.BAMBOO_RAFT) || item.equals(Material.BAMBOO_SIGN) || item.equals(Material.BAMBOO_SLAB) || item.equals(Material.BAMBOO_STAIRS) || item.equals(Material.BAMBOO_TRAPDOOR) || item.equals(Material.BAMBOO_WALL_HANGING_SIGN) || item.equals(Material.BAMBOO_WALL_SIGN) || item.equals(Material.BIRCH_BOAT) || item.equals(Material.BIRCH_CHEST_BOAT) || item.equals(Material.BIRCH_DOOR) || item.equals(Material.BIRCH_FENCE) || item.equals(Material.BIRCH_FENCE_GATE) || item.equals(Material.BIRCH_HANGING_SIGN) || item.equals(Material.BIRCH_LEAVES) || item.equals(Material.BIRCH_PLANKS) || item.equals(Material.BIRCH_SIGN) || item.equals(Material.BIRCH_SLAB) || item.equals(Material.BIRCH_STAIRS) || item.equals(Material.BIRCH_TRAPDOOR) || item.equals(Material.BIRCH_WALL_HANGING_SIGN) || item.equals(Material.BIRCH_WALL_SIGN) || item.equals(Material.BIRCH_WOOD) || item.equals(Material.CHERRY_BOAT) || item.equals(Material.CHERRY_CHEST_BOAT) || item.equals(Material.CHERRY_DOOR) || item.equals(Material.CHERRY_FENCE) || item.equals(Material.CHERRY_FENCE_GATE) || item.equals(Material.CHERRY_HANGING_SIGN) || item.equals(Material.CHERRY_LEAVES) || item.equals(Material.CHERRY_PLANKS) || item.equals(Material.CHERRY_SIGN) || item.equals(Material.CHERRY_SLAB) || item.equals(Material.CHERRY_STAIRS) || item.equals(Material.CHERRY_TRAPDOOR) || item.equals(Material.CHERRY_WALL_HANGING_SIGN) || item.equals(Material.CHERRY_WALL_SIGN) || item.equals(Material.CHERRY_WOOD) || item.equals(Material.CRIMSON_DOOR) || item.equals(Material.CRIMSON_FENCE) || item.equals(Material.CRIMSON_FENCE_GATE) || item.equals(Material.CRIMSON_FUNGUS) || item.equals(Material.CRIMSON_HANGING_SIGN) || item.equals(Material.CRIMSON_HYPHAE) || item.equals(Material.CRIMSON_NYLIUM) || item.equals(Material.CRIMSON_PLANKS) || item.equals(Material.CRIMSON_ROOTS) || item.equals(Material.CRIMSON_SIGN) || item.equals(Material.CRIMSON_SLAB) || item.equals(Material.CRIMSON_STAIRS) || item.equals(Material.CRIMSON_STEM) || item.equals(Material.CRIMSON_TRAPDOOR) || item.equals(Material.CRIMSON_WALL_HANGING_SIGN) || item.equals(Material.CRIMSON_WALL_SIGN) || item.equals(Material.DARK_OAK_BOAT) || item.equals(Material.DARK_OAK_CHEST_BOAT) || item.equals(Material.DARK_OAK_DOOR) || item.equals(Material.DARK_OAK_FENCE) || item.equals(Material.DARK_OAK_FENCE_GATE) || item.equals(Material.DARK_OAK_HANGING_SIGN) || item.equals(Material.DARK_OAK_LEAVES) || item.equals(Material.DARK_OAK_PLANKS) || item.equals(Material.DARK_OAK_SIGN) || item.equals(Material.DARK_OAK_SLAB) || item.equals(Material.DARK_OAK_STAIRS) || item.equals(Material.DARK_OAK_TRAPDOOR) || item.equals(Material.DARK_OAK_WALL_HANGING_SIGN) || item.equals(Material.DARK_OAK_WALL_SIGN) || item.equals(Material.DARK_OAK_WOOD) || item.equals(Material.JUNGLE_BOAT) || item.equals(Material.JUNGLE_CHEST_BOAT) || item.equals(Material.JUNGLE_DOOR) || item.equals(Material.JUNGLE_FENCE) || item.equals(Material.JUNGLE_FENCE_GATE) || item.equals(Material.JUNGLE_HANGING_SIGN) || item.equals(Material.JUNGLE_PLANKS) || item.equals(Material.JUNGLE_SIGN) || item.equals(Material.JUNGLE_SLAB) || item.equals(Material.JUNGLE_STAIRS) || item.equals(Material.JUNGLE_TRAPDOOR) || item.equals(Material.JUNGLE_WALL_HANGING_SIGN) || item.equals(Material.JUNGLE_WALL_SIGN) || item.equals(Material.MANGROVE_BOAT) || item.equals(Material.MANGROVE_CHEST_BOAT) || item.equals(Material.MANGROVE_DOOR) || item.equals(Material.MANGROVE_FENCE) || item.equals(Material.MANGROVE_FENCE_GATE) || item.equals(Material.MANGROVE_HANGING_SIGN) || item.equals(Material.MANGROVE_PLANKS) || item.equals(Material.MANGROVE_PROPAGULE) || item.equals(Material.MANGROVE_ROOTS) || item.equals(Material.MANGROVE_SIGN) || item.equals(Material.MANGROVE_SLAB) || item.equals(Material.MANGROVE_STAIRS) || item.equals(Material.MANGROVE_TRAPDOOR) || item.equals(Material.MANGROVE_WALL_HANGING_SIGN) || item.equals(Material.MANGROVE_WALL_SIGN) || item.equals(Material.OAK_BOAT) || item.equals(Material.OAK_CHEST_BOAT) || item.equals(Material.OAK_DOOR) || item.equals(Material.OAK_FENCE) || item.equals(Material.OAK_FENCE_GATE) || item.equals(Material.OAK_HANGING_SIGN) || item.equals(Material.OAK_PLANKS) || item.equals(Material.OAK_SIGN) || item.equals(Material.OAK_SLAB) || item.equals(Material.OAK_STAIRS) || item.equals(Material.OAK_TRAPDOOR) || item.equals(Material.OAK_WALL_HANGING_SIGN) || item.equals(Material.OAK_WALL_SIGN) || item.equals(Material.SPRUCE_BOAT) || item.equals(Material.SPRUCE_CHEST_BOAT) || item.equals(Material.SPRUCE_DOOR) || item.equals(Material.SPRUCE_FENCE) || item.equals(Material.SPRUCE_FENCE_GATE) || item.equals(Material.SPRUCE_HANGING_SIGN) || item.equals(Material.SPRUCE_PLANKS) || item.equals(Material.SPRUCE_SIGN) || item.equals(Material.SPRUCE_SLAB) || item.equals(Material.SPRUCE_STAIRS) || item.equals(Material.SPRUCE_TRAPDOOR) || item.equals(Material.SPRUCE_WALL_HANGING_SIGN) || item.equals(Material.SPRUCE_WALL_SIGN) || item.equals(Material.STICK);
            }
